...
function RouteComponent() {
  const { country, competition, broadcaster } = Route.useParams()
  ...
  const title =
    countryData && competitionData && broadcasterData
      ? `${competitionData.name} in ${countryData.name} on ${broadcasterData.name}`
      : 'Matches'
